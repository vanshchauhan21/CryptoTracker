...
import './BuyBitcoinSection.css';
import bitcoinImage from '../../assets/bitcoin.jpg'; 

const BuyBitcoinSection = () => {
  return (
    <section className="buy-bitcoin-section">
      ...
      <div className="content-wrapper">
        ...
        >
          ...
          <p>Join the digital revolution with Bitcoin. Secure, decentralized, and limitless potential.</p>
        </motion.div>
        <motion.div 
...
export default BuyBitcoinSection;